...
// if not used, pull this pin to GND!
#define INT0_PIN PD2

// if no other SPI master is connected, connect this pin to VCC
...
static void display_init() {
    PORTD &= ~(1 << DISP_RST);  // display HW reset (will not clear the buffer)
    PORTD |= (1 << DISP_RST);   // disable display HW reset
